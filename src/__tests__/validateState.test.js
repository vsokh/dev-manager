...
describe('validateState', () => {
  ...
  it('invalid dependsOn detected', () => {
    ...
    // dependsOn items must be numbers
  ...
  it('queue validation', () => {
    // queue must be an array if present
    const result1 = validateState({
      tasks: [{ id: 1, name: 'Task 1' }],
      queue: 'not-array',
    });
    ...
    // queue items must have task (number) and taskName (string)
    const result2 = validateState({
      tasks: [{ id: 1, name: 'Task 1' }],
  ...
  it('activity validation', () => {
    // activity must be an array if present
    const result1 = validateState({
      tasks: [{ id: 1, name: 'Task 1' }],
      activity: 'not-array',
    });
