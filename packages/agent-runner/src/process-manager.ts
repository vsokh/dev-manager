...
export class ProcessManager {
  ...
  launchProcess(projectPath: string, taskId: number, command: string, engine = 'claude', model?: string, preamble?: string): LaunchResult {
    ...
    const { cmd, args } = adapter(command, { model, preamble });
